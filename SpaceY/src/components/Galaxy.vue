...
// ========== 重点！删掉所有TS类型定义，Vue3原生props默认值 ==========
const props = defineProps({
  focal: { default: [0.5, 0.5] },
  rotation: { default: [1.0, 0.0] },
  starSpeed: { default: 0.5 },
  density: { default: 1 },
  hueShift: { default: 140 },
  disableAnimation: { default: false },
  speed: { default: 1.0 },
  mouseInteraction: { default: true },
  glowIntensity: { default: 0.3 },
  saturation: { default: 0.0 },
  mouseRepulsion: { default: true },
  twinkleIntensity: { default: 0.3 },
  rotationSpeed: { default: 0.1 },
  repulsionStrength: { default: 2 },
  autoCenterRepulsion: { default: 0 },
  transparent: { default: false } // 🔴 关键！改成false，自带纯黑深空底色，不再发空发黑
});
...
<!-- ========== 原生CSS全屏！彻底删掉Tailwind！ ========== -->
<template>
  <div ref="ctnDom" class="galaxy-wrap" v-bind="$attrs"></div>
</template>
